...
## 코랩 사용법
- **코랩 링크**: [Colab 사용 가이드](https://drive.google.com/drive/u/1/folders/1X51Jkzlh0luXZ8uzTqaInqTT773QgvPP)
...
## 인터페이스 사용법
- **링크**: [Interface 사용 가이드](https://github.com/yunariver/AImaker-jobplaying/blob/main/README.md)
- **Tip**: 영상과 GIF를 통해 쉽게 이해할 수 있습니다!

### [가이드]
- **전체화면**: `Ctrl`(또는 `Cmd`)+`Shift`+`F`
- **게임 시작**: 첫 사용 시 "게임시작"을 입력하세요.

### [문자 입력]
- 텍스트 박스에 입력 후 `Enter` 키를 눌러 전송하세요. 전송 후 약 10초 대기 시간이 필요합니다.
- 다음 입력 전, 텍스트박스 내용을 수동으로 지워야 합니다.
